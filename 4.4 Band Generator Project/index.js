...
app.get("/", (req, res) => {
  res.render("index.ejs", {one: one, two: two});
});
...
app.post("/submit", (req, res) => {
  ...
  one = Math.floor((Math.random())*adj.length);
  two = Math.floor((Math.random())*adj.length);
  res.render("index.ejs", {first: adj[one], second: noun[two]});
});
